package com.example.ffbclient.db.base;
...
import com.example.ffbclient.db.DaoMaster;
import com.example.ffbclient.db.DaoSession;
import com.example.ffbclient.db.interfaces.IDatabase;
...
public abstract class BaseManager<M, K> implements IDatabase<M, K> {
    ...
    public static final String DEFAULT_DATABASE_NAME = "ffbContorl.db";
